...
class Record extends loop.Loop {
    constructor() {
        super({ interval: 1 });
        this.started = false;
        this.canceled = false;
...
const delay = loop.Loop.delay;
const { request, cancel } = loop.Loop.prototype;
class Recordable extends loop.Loop {
...
Object.defineProperties(loop.Loop, staticProperties);
Object.defineProperties(loop.Loop.prototype, properties);
