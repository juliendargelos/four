...
class Loop {
    constructor({ interval = 0, fixed = false, type = 'immediate', clockType = undefined, clock: clock$1 = new clock.Clock({ type: clockType }) } = {}) {
        this.throttle = clock.Clock.throttle(() => this.interval);
